                ...
                <div class="row">
                    <div class="col-sm prezenter">
                        <div class="text-block kanal1">
                            ...
                            Prezenter: <span><?php echo getShoutcastStats($ip1, $port1, 1, 'servergenre'); ?></span>
                        </div>
                    </div>
                    <div class="col-sm audycja">
                        <div class="text-block kanal1">
                            <!-- MIEJSCE DO ZAKODOWANIA METADANYCH POLE AUDYCJA -->
                            Audycja: <span><?php echo getShoutcastStats($ip1, $port1, 1, 'servertitle'); ?></span>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-sm prezenter">
                        <div class="text-block">
                            <!-- MIEJSCE DO ZAKODOWANIA METADANYCH POLE PREZENTERA -->
                            Prezenter: <span><?php echo getShoutcastStats($ip2, $port2, 1, 'servergenre'); ?></span>
                        </div>
                    </div>
                    <div class="col-sm audycja">
                        <div class="text-block">
                            <!-- MIEJSCE DO ZAKODOWANIA METADANYCH POLE AUDYCJA -->
                            Audycja: <span><?php echo getShoutcastStats($ip2, $port2, 1, 'servertitle'); ?></span>
                        </div>
                    </div>
                </div>
            </div>
